...
app=FastAPI(title='Family Finance Bot',version='1.9.1-mvp',docs_url='/docs',redoc_url=None,lifespan=lifespan)
...
@app.get('/health')
async def health(): return {'status':'ok','version':'1.9.1-mvp'}
