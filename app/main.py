...
app=FastAPI(title='Family Finance Bot',version='1.3.0-mvp',docs_url='/docs',redoc_url=None,lifespan=lifespan)
...
@app.get('/health')
async def health(): return {'status':'ok','version':'1.3.0-mvp'}
